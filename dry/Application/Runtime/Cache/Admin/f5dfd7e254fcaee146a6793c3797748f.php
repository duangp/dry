...
<table>
    ...
    <form action="/dry/dry/admin.php/Plateyield/add" enctype="multipart/form-data" method="post">
            <tr>
                <td><input type="text" name="py_year"></td>
                <td><input type="text" name="py_month"></td>
