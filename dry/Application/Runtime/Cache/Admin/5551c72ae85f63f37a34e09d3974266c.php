...
<table>
    ...
    <form action="/dry/dry/admin.php/Discardedppm/update/id/<?php echo ($info["dp_id"]); ?>" enctype="multipart/form-data" method="post">
            <tr>
                <td><input type="text" name="dp_year" value="<?php echo ($info["dp_year"]); ?>"></td>
                <td><input type="text" name="dp_month" value="<?php echo ($info["dp_month"]); ?>"></td>
                <td><input type="text" name="for" value="<?php echo ($info["for"]); ?>"></td>
