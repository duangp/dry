            ...
            <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                <div class="panel-body no-padding">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <?php if(in_array(($_SESSION['uid']), explode(',',"1,2"))): ?><form action="/dry/dry/admin.php/Discardedppm/update/id/<?php echo ($info["dp_id"]); ?>" enctype="multipart/form-data" method="post">
                                <tr>
                                    <td>
                                        <select name="dp_year">
