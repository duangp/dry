...
<table>
    ...
    <form action="/dry/dry/admin.php/Drybatteryoutput/update/id/<?php echo ($info["dbo_id"]); ?>" enctype="multipart/form-data" method="post">
            <tr>
                <td><input type="text" name="dbo_year" value="<?php echo ($info["dbo_year"]); ?>"></td>
                <td><input type="text" name="dbo_month" value="<?php echo ($info["dbo_month"]); ?>"></td>
