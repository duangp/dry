...
<table>
    ...
    <form action="/dry/dry/admin.php/Plateyield/update/id/<?php echo ($info["py_id"]); ?>" enctype="multipart/form-data" method="post">
            <tr>
                <td><input type="text" name="py_year" value="<?php echo ($info["py_year"]); ?>"></td>
                <td><input type="text" name="py_month" value="<?php echo ($info["py_mouth"]); ?>"></td>
