...
<table>
    ...
    <form action="/dry/dry/admin.php/Yieldproduction/update/id/<?php echo ($info["yp_id"]); ?>" enctype="multipart/form-data" method="post">
            <tr>
                <td><input type="text" name="yp_year" value="<?php echo ($info["yp_year"]); ?>"></td>
                <td><input type="text" name="yp_month" value="<?php echo ($info["yp_month"]); ?>"></td>
                <td><input type="text" name="fna" value="<?php echo ($info["fna"]); ?>"></td>
                <td><input type="text" name="shp" value="<?php echo ($info["shp"]); ?>"></td>
            </tr>
